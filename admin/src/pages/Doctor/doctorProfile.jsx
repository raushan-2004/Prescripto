      ...
      <div className='flex flex-col gap-4 m-5'>
        ...
        <div className='flex-1 border border-stone-100 rounded-lg p-8 py-7 bg-white'>
          ...
          <div>
            ...
            <p className='text-sm text-gray-600 max-w-full mt-1'>
              {profileData.about}
            </p>
          </div>

          <p className='text-gray-600 font-medium mt-4'>
            Appointment Fee: <span className='text-gray-800'>{currency} {isEdit ? <input type="number" value={profileData.fee} onChange={(e) => setProfileData(prev => ({ ...profileData, fee: e.target.value }))} /> : profileData.fee}</span>
          </p>
