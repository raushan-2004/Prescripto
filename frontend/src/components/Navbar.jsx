        ...
        <div className='flex items-center gap-4'>
            {
                ...
                :  <button  onClick={() => navigate("/login")} className='cursor-pointer bg-indigo-500 text-white py-3 px-8 rounded-full font-light hidden md:block'>Create Account</button>
            }
            ...
            <div className={` ${showMenu ? 'fixed w-full' : 'h-0 w-0'} md:hidden right-0 top-0 bottom-0 z-20 overflow-hidden bg-white transition-all`}>
                ...
                <ul className='flex flex-col items-center gap-2 px-5 mt-5 font-medium '>
